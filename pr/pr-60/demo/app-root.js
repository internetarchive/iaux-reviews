...
`;let q=class extends se{constructor(){super(...arguments),this.maxSubjectLength=100,this.maxBodyLength=150,this.baseHost="https://archive.org",this.csrfToken="",this.canDelete=!1,this.bypassTruncation=!1,this.showTruncatedContent=!1,this.deleteMsg=""}render(){return this.review?v`
    ...
    `}};l([b({type:Object})],q.prototype,"review",void 0);l([b({type:String})],q.prototype,"identifier",void 0);l([b({type:Number})],q.prototype,"maxSubjectLength",void 0);l([b({type:Number})],q.prototype,"maxBodyLength",void 0);l([b({type:String})],q.prototype,"baseHost",void 0);l([b({type:String})],q.prototype,"csrfToken",void 0);l([b({type:Boolean})],q.prototype,"canDelete",void 0);l([b({type:Boolean})],q.prototype,"bypassTruncation",void 0);l([k()],q.prototype,"showTruncatedContent",void 0);l([k()],q.prototype,"deleteMsg",void 0);q=l([Je("ia-review")],q);let M=class extends se{constructor(){super(...arguments),this.token="",this.baseHost="https://archive.org",this.endpointPath="/write-review.php",this.submitterScreenname="Anonymous",this.bypassRecaptcha=!1,this.currentStars=0,this.currentSubjectLength=0,this.currentBodyLength=0,this.formCanSubmit=!1,this.submissionInProgress=!1,this.RECAPTCHA_ERROR_MESSAGE="Could not validate review. Please try again later.",this.GENERIC_ERROR_MESSAGE="There's been a temporary error. Please wait a moment and try again."}render(){return v`<form id="review-form" @submit=${this.handleSubmit}>
