...
`;let C=class extends se{constructor(){super(...arguments),this.reviewsDisabled=!1,this.reviewsFrozen=!1,this.canDelete=!1,this.showReviewsByDefault=!1,this.baseHost="https://archive.org",this.token="",this.endpointPath="/write-review.php",this.submitterScreenname="Anonymous",this.bypassRecaptcha=!1,this.fetchHandler=new es,this.displayReviewForm=!1,this.displayReviews=!1,this.reviewsCount=0}render(){return v`
      <span class="left-icon">${Ri}</span>
      <div class="reviews">
        ${this.reviewsTitleTemplate} ${this.reviewsListTemplate}
      </div>
    `}updated(e){e.has("ownReview")&&(this.currentReview=this.ownReview,this.updateReviewsCount()),e.has("reviews")&&this.updateReviewsCount(),e.has("showReviewsByDefault")&&this.showReviewsByDefault&&(this.displayReviews=!0)}get reviewsTitleTemplate(){return v`
