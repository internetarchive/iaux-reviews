 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Yt=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},en=(i,e,t)=>{e.constructor.createProperty(t,i)};function S(i){return(e,t)=>t!==void 0?en(i,e,t):Yt(i,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function k(i){return S({...i,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const fn=i=>hn(i)?pn(i.strings,i.values):i;let x=fn;/**
 * @license
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */let mn=new gn;mn.resolve();const yn=kt`
  ...
  <path
    ...
    fill="#e0e0e0"
  />
</svg>`,ht=$`var(--white, #fff)`,$n=$`var(--ia-theme-link-color, #4b64ff)`,bn=$`var(--primaryDisableCTAFill, #767676)`,_n=$`var(--secondaryCTABorder, #999)`,vn=$`var(--primaryCTAFill, #194880)`,Ce=$`var(--primaryCTAFillRGB, 25, 72, 128)`,An=$`var(--primaryCTABorder, #c5d1df)`,xn=$`var(--primaryErrorCTAFill, #d9534f)`,Re=$`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Sn=$`var(--primaryErrorCTABorder, #d43f3a)`,Mn=$`var(--secondaryCTAFill, #333)`,Be=$`var(--secondaryCTAFillRGB, 51, 51, 51)`,En=$`var(--primaryCTABorder, #979797)`,kn=$`var(---primaryWarningFill, #ee8950)`,Le=$`var(--primaryWarningFillRGB, 238, 137, 80)`,Cn=$`var(--primaryWarningBorder, #ec7939)`,Rn=$`
  .ia-button {
    min-height: 3rem;
    cursor: pointer;
    color: ${ht};
...
`;let b=class extends F{constructor(){super(...arguments),this.baseHost="https://archive.org",this.endpointPath="/write-review.php",this.prefilledErrors=[],this.bypassRecaptcha=!1,this.recaptchaToken="",this.recaptchaError=!1,this.currentStars=0,this.currentSubjectLength=0,this.currentBodyLength=0,this.formCanSubmit=!1}render(){return v`<form
      ...
      method="post"
    >
      ${this.prefilledErrors.length?this.prefilledErrors.map(e=>v`<div class="errors prefilled-error">${e}</div>`):y}
    ...
    />${this.maxSubjectLength?v`
          ...
          `:y}</div></span>`}get bodyInputTemplate(){var e,t;return v`<span
      id="body-input"
      ...
      ${this.identifier?v`<input
          ...
          />`:y}`}get actionButtonsTemplate(){return v`<div class="action-btns">
      ${this.identifier?v`<a
      ...
      >
        ${e<=this.currentStars?yn:wn}
      </button>
    `}async setupRecaptcha(){var e;try{this.recaptchaWidget=await((e=this.recaptchaManager)===null||e===void 0?void 0:e.getRecaptchaWidget()),this.recaptchaError=!1}catch{this.recaptchaError=!0}}async handleSubmit(e){if(e.preventDefault(),!!this.reviewForm.reportValidity()){if(this.bypassRecaptcha){this.reviewForm.requestSubmit();return}if(!this.recaptchaWidget){this.recaptchaError=!0;return}try{const t=await this.recaptchaWidget.execute();this.dispatchEvent(new Event("recaptchaFinished")),this.recaptchaToken=t,await this.updateComplete,this.reviewForm.requestSubmit()}catch{this.recaptchaError=!0}}}handleStarClicked(e,t){e.preventDefault(),this.setStars(t)}handleClearBtnClicked(e){e.preventDefault(),this.currentStars=0}setStars(e){this.currentStars=e===this.currentStars?0:e}handleSubjectChanged(e){const t=e.target;this.currentSubjectLength=t.value.length}handleBodyChanged(e){const t=e.target;this.currentBodyLength=t.value.length}checkSubmissionAllowed(){return!(this.maxSubjectLength&&this.currentSubjectLength>this.maxSubjectLength||this.maxBodyLength&&this.currentBodyLength>this.maxBodyLength)}static get styles(){return[Rn,$`
        :host {
          font-family: var(
            --ia-font-stack,
            'Helvetica Neue',
