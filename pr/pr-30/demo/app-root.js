...
`;let ie=class extends le{constructor(){super(...arguments),this.maxSubjectLength=100,this.maxBodyLength=150,this.baseHost="https://archive.org",this.canDelete=!1,this.showTruncatedContent=!1,this.deleteMsg=""}render(){return this.review?A`
    ...
    `}};d([R({type:Object})],ie.prototype,"review",void 0);d([R({type:Number})],ie.prototype,"maxSubjectLength",void 0);d([R({type:Number})],ie.prototype,"maxBodyLength",void 0);d([R({type:String})],ie.prototype,"baseHost",void 0);d([R({type:Boolean})],ie.prototype,"canDelete",void 0);d([V()],ie.prototype,"showTruncatedContent",void 0);d([V()],ie.prototype,"deleteMsg",void 0);ie=d([bt("ia-review")],ie);let x=class extends le{constructor(){super(...arguments),this.token="",this.baseHost="https://archive.org",this.endpointPath="/write-review.php",this.displayMode="form",this.submitterScreenname="Anonymous",this.fetchHandler=new za,this.bypassRecaptcha=!1,this.canDelete=!1,this.currentStars=0,this.currentSubjectLength=0,this.currentBodyLength=0,this.formCanSubmit=!1,this.submissionInProgress=!1,this.RECAPTCHA_ERROR_MESSAGE="Could not validate review. Please try again later.",this.GENERIC_ERROR_MESSAGE="There's been a temporary error. Please wait a moment and try again."}render(){return this.displayMode==="review"?this.reviewTemplate:A`<form id="review-form" @submit=${this.handleSubmit}>
