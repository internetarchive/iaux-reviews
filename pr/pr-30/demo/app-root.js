 ...
 */const le=window,ze=le.ShadowRoot&&(le.ShadyCSS===void 0||le.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Fe=Symbol(),Ke=new WeakMap;let yt=class{constructor(e,t,r){if(this._$cssResult$=!0,r!==Fe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o;const t=this.t;if(ze&&e===void 0){const r=t!==void 0&&t.length===1;r&&(e=Ke.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),r&&Ke.set(t,e))}return e}toString(){return this.cssText}};const Lt=i=>new yt(typeof i=="string"?i:i+"",void 0,Fe),b=(i,...e)=>{const t=i.length===1?i[0]:e.reduce((r,n,s)=>r+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(n)+i[s+1],i[0]);return new yt(t,i,Fe)},Tt=(i,e)=>{ze?i.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet):e.forEach(t=>{const r=document.createElement("style"),n=le.litNonce;n!==void 0&&r.setAttribute("nonce",n),r.textContent=t.cssText,i.appendChild(r)})},Ze=ze?i=>i:i=>i instanceof CSSStyleSheet?(e=>{let t="";for(const r of e.cssRules)t+=r.cssText;return Lt(t)})(i):i;/**
 * @license
...
`;const Tr=We`
  ...
  <path
    ...
    fill="currentColor"
  />
</svg>`;let z=class extends O{constructor(){super(...arguments),this.maxSubjectLength=100,this.maxBodyLength=1e3,this.baseHost="https://archive.org",this.showTruncatedContent=!1}render(){return this.review?y`<article class="review" id=${this.review.domId}>
          <div class="top-line">
    ...
    `}};l([x({type:Object})],z.prototype,"review",void 0);l([x({type:Number})],z.prototype,"maxSubjectLength",void 0);l([x({type:Number})],z.prototype,"maxBodyLength",void 0);l([x({type:String})],z.prototype,"baseHost",void 0);l([M()],z.prototype,"showTruncatedContent",void 0);z=l([qe("ia-review")],z);let v=class extends O{constructor(){super(...arguments),this.token="",this.baseHost="https://archive.org",this.endpointPath="/write-review.php",this.displayMode="form",this.prefilledErrors=[],this.bypassRecaptcha=!1,this.recaptchaToken="",this.recaptchaError=!1,this.currentStars=0,this.currentSubjectLength=0,this.currentBodyLength=0,this.formCanSubmit=!1}render(){return this.displayMode==="review"?this.reviewTemplate:y`<form
          id="review-form"
