 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pi=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},Bi=(i,e,t)=>{e.constructor.createProperty(t,i)};function $(i){return(e,t)=>t!==void 0?Bi(i,e,t):Pi(i,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function M(i){return $({...i,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;var Sr;(function(i){i.processing="processing",i.complete="complete"})(Sr||(Sr={}));let vn=class extends se{constructor(){super(...arguments),this.mode="processing"}render(){return y`
    ...
    `}};l([$({type:String})],vn.prototype,"mode",void 0);vn=l([Je("ia-activity-indicator")],vn);const Ha=bt`
...
`;let Y=class extends se{constructor(){super(...arguments),this.maxSubjectLength=100,this.maxBodyLength=150,this.baseHost="https://archive.org",this.canDelete=!1,this.bypassTruncation=!1,this.showTruncatedContent=!1,this.deleteMsg=""}render(){return this.review?y`
    ...
    >
      ${E("...Less")}
          ...
          `:y`${Tr(this.review.reviewer)}`:A}get starsTemplate(){return!this.review||!this.review.stars?A:y`
      <div
        class="review-stars"
    ...
    `:this.displayReviewsMsgTemplate}willUpdate(e){var t;(!this.activeReviewService||e.has("reviewService")||e.has("baseHost"))&&(this.activeReviewService=(t=this.reviewService)!==null&&t!==void 0?t:new Kr({baseHost:this.baseHost})),(e.has("reviews")||e.has("submitterItemname"))&&(this.reviewsCount=this.reviews.length,this.sortFilterReviews()),e.has("displayReviewForm")&&this.displayReviewForm===!0&&(!this.bypassRecaptcha&&!this.recaptchaActivated&&(this.recaptchaActivated=!0),this.displayReviews=!0),e.has("displayReviewsByDefault")&&this.displayReviewsByDefault&&(this.displayReviews=!0)}get reviewsDisabledTemplate(){return y`<div class="message">
