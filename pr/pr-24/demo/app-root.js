 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Pi=(i,e)=>e.kind==="method"&&e.descriptor&&!("value"in e.descriptor)?{...e,finisher(t){t.createProperty(e.key,i)}}:{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){typeof e.initializer=="function"&&(this[e.key]=e.initializer.call(this))},finisher(t){t.createProperty(e.key,i)}},Oi=(i,e,t)=>{e.constructor.createProperty(t,i)};function R(i){return(e,t)=>t!==void 0?Oi(i,e,t):Pi(i,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ji=i=>Xi(i)?Zi(i.strings,i.values):i;let C=Ji;/**
 * @license
...
`;var Er;(function(i){i.processing="processing",i.complete="complete"})(Er||(Er={}));let gn=class extends le{constructor(){super(...arguments),this.mode="processing"}render(){return _`
      <div class="${this.mode}">
        <svg
          viewBox="0 0 120 120"
...
`;let ee=class extends le{constructor(){super(...arguments),this.maxSubjectLength=100,this.maxBodyLength=150,this.baseHost="https://archive.org",this.canDelete=!1,this.showTruncatedContent=!1,this.deleteMsg=""}render(){return this.review?_`
          <article class="review" id=${this.generateDomId()}>
            ...
            <div class="body">
              ${this.deleteMsg?_`<i>${C(this.deleteMsg)}</i>`:this.bodyTemplate}
            </div>
    ...
    >
      ${C("...Less")}
          ...
          `:_`${Sr(this.review.reviewer)}`:v}get starsTemplate(){return!this.review||!this.review.stars?v:_`
      <div
        class="review-stars"
        title="${C(`${this.review.stars} out of 5 stars`)}"
      >
        ${new Array(Number(this.review.stars)).fill(null).map(()=>_`<div class="review-star">${Wa}</div>`)}
      </div>
      -
    `}get createDateTemplate(){var e,t;if(!(!((e=this.review)===null||e===void 0)&&e.createdate)||!(!((t=this.review)===null||t===void 0)&&t.reviewdate))return v;const n=new Date(this.review.reviewdate),r=new Date(this.review.createdate),a=r.toLocaleString("en-us",{month:"long",day:"numeric",year:"numeric"}),s=n.getTime()!==r.getTime()?"(edited)":"";return C(`${a} ${s}`)}generateDomId(){var e;return!((e=this.review)===null||e===void 0)&&e.createdate?`review-${Date.parse(this.review.createdate.toString())}`:""}prepReview(e){return Za(Xa(e))}async deleteReview(){if(!this.review||!this.identifier||!confirm(C("Are you sure you want to delete this review?")))return;const e=`${this.baseHost}/edit-reviews.php?identifier=${this.identifier}&deleteReviewer=${this.review.reviewer}`;try{await fetch(e,{method:"POST"}),this.deleteMsg="This review has been queued for deletion."}catch{this.deleteMsg="Sorry, we were unable to delete this review."}}static get styles(){return S`
      :host {
        font-family: var(
          --ia-font-stack,
          'Helvetica Neue',
    ...
    `:v}get unrecoverableErrorTemplate(){return this.unrecoverableError?_`
          <div class="unrecoverable-error">
            <span class="error-msg">${C(this.unrecoverableError)}</span>
          </div>
        `:v}get recoverableErrorTemplate(){return this.recoverableError?_`
          <div class="recoverable-error">
            ${zr(this.sanitizeErrorMsg(C(this.recoverableError)))}
          </div>
        `:v}get recaptchaMessageTemplate(){return this.bypassRecaptcha?v:_`${C(_`This site is protected by reCAPTCHA and the Google
        <a
          target="_blank"
          class="inline-link"
        ...
        <a
          ...
          >Terms of Service</a
        >
        apply.`)}`}get starsInputTemplate(){return _`
    ...
    </div>`}renderStar(e){const t=e===this.currentStars,n=C(`Rate ${e>1?`${e} stars`:"1 star"}`);return _`
      <button
        class="star star-${e}"
    ...
    `}async setupRecaptcha(){var e;try{this.recaptchaWidget=await((e=this.recaptchaManager)===null||e===void 0?void 0:e.getRecaptchaWidget())}catch{this.unrecoverableError=this.RECAPTCHA_ERROR_MESSAGE}}sanitizeErrorMsg(e){return mn.sanitize(e,{ALLOWED_TAGS:["a","b","br"]})}async handleSubmit(e){var t;if(e.preventDefault(),!(!this.formCanSubmit||this.submissionInProgress)){if(this.submissionInProgress=!0,this.recoverableError="",!this.reviewForm.reportValidity())return this.stopSubmission();try{const n=new URLSearchParams;if(!this.bypassRecaptcha){const a=await this.getRecaptchaToken();if(!a)return this.handleRecaptchaError();n.append("g-recaptcha-response",a??"")}for(const a of new FormData(this.reviewForm))n.append(a[0],a[1]);n.append("submitter","review-form");const r=await this.fetchHandler.fetchApiResponse(`${this.baseHost}${this.endpointPath}`,{method:"POST",includeCredentials:!0,body:n});(r==null?void 0:r.success)===!0?(this.submissionInProgress=!1,this.oldReview=this.generateSubmittedReview(),this.displayMode="review"):(this.recoverableError=(t=r.error)!==null&&t!==void 0?t:this.GENERIC_ERROR_MESSAGE,this.stopSubmission())}catch(n){console.error(n),this.recoverableError=this.GENERIC_ERROR_MESSAGE,this.stopSubmission()}}}generateSubmittedReview(){var e,t,n,r,a,s;const c=new Date().toDateString();return new ie({reviewtitle:this.reviewForm.field_reviewtitle.value,reviewbody:this.reviewForm.field_reviewbody.value,stars:this.reviewForm.field_stars.value,reviewdate:c,reviewer:(t=(e=this.oldReview)===null||e===void 0?void 0:e.reviewer)!==null&&t!==void 0?t:this.submitterScreenname,reviewer_itemname:(r=(n=this.oldReview)===null||n===void 0?void 0:n.reviewer_itemname)!==null&&r!==void 0?r:this.submitterItemname,createdate:(s=this.dateToString((a=this.oldReview)===null||a===void 0?void 0:a.createdate))!==null&&s!==void 0?s:c})}dateToString(e){return e instanceof Date?e.toDateString():e}async getRecaptchaToken(){if(!this.recaptchaWidget){this.handleRecaptchaError();return}try{return await this.recaptchaWidget.execute()}catch{this.handleRecaptchaError();return}}handleRecaptchaError(){this.recoverableError=this.RECAPTCHA_ERROR_MESSAGE,this.stopSubmission()}stopSubmission(){this.submissionInProgress&&(this.submissionInProgress=!1)}handleStarClicked(e,t){e.preventDefault(),this.setStars(t)}handleClearBtnClicked(e){e.preventDefault(),this.currentStars=0}setStars(e){this.currentStars=e===this.currentStars?0:e}handleSubjectChanged(e){const t=e.target;this.currentSubjectLength=t.value.length}handleBodyChanged(e){const t=e.target;this.currentBodyLength=t.value.length}checkSubmissionAllowed(){return!(this.unrecoverableError||!this.currentBodyLength||!this.currentSubjectLength||this.maxSubjectLength&&this.currentSubjectLength>this.maxSubjectLength||this.maxBodyLength&&this.currentBodyLength>this.maxBodyLength)}static get styles(){return[Oa,S`
      ...
      ${this.review!==this.mockOldReview?_`<button @click=${()=>this.review=this.mockOldReview}>
            Prefill normal review
          </button>`:v}
      ${this.review!==this.longReview?_`<button @click=${()=>this.review=this.longReview}>
            Prefill long review
          </button>`:v}
      ${this.review!==this.reviewWithLink?_`<button @click=${()=>this.review=this.reviewWithLink}>
            Prefill review with link
          </button>`:v}
      ${this.review!==this.reviewWithTextLink?_`<button @click=${()=>this.review=this.reviewWithTextLink}>
