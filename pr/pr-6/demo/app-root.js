 ...
 */var le;((le=window.HTMLSlotElement)===null||le===void 0?void 0:le.prototype.assignedElements)!=null;const Ct=Xe`
  ...
  <path
    ...
    fill="#e0e0e0"
  />
</svg>`,je=_`var(--white, #fff)`,Ht=_`var(--primaryDisableCTAFill, #767676)`,kt=_`var(--secondaryCTABorder, #999)`,Tt=_`var(--primaryCTAFill, #194880)`,de=_`var(--primaryCTAFillRGB, 25, 72, 128)`,Nt=_`var(--primaryCTABorder, #c5d1df)`,Rt=_`var(--primaryErrorCTAFill, #d9534f)`,ae=_`var(--primaryErrorCTAFillRGB, 229, 28, 38)`,Pt=_`var(--primaryErrorCTABorder, #d43f3a)`,Bt=_`var(--secondaryCTAFill, #333)`,ue=_`var(--secondaryCTAFillRGB, 51, 51, 51)`,Ut=_`var(--primaryCTABorder, #979797)`,Mt=_`#ee8950`,Ot=_`#ec7939`,jt=_`
  .ia-button {
    height: 3.5rem;
    min-height: 3rem;
    cursor: pointer;
...
`;let A=class extends N{constructor(){super(...arguments),this.baseHost="https://archive.org",this.endpointPath="/write-review.php",this.currentStars=0}render(){return g`<form action=${`${this.baseHost}${this.endpointPath}`}>
    ...
    `}get subjectInputTemplate(){var e,t;return g`<div class="form-heading">
      ...
      <input
        ...
        id="subject-input"
        .value=${(t=(e=this.oldReview)===null||e===void 0?void 0:e.subject)!==null&&t!==void 0?t:""}
        required
      ...
      <textarea
        ...
        id="body-input"
        .value=${(t=(e=this.oldReview)===null||e===void 0?void 0:e.body)!==null&&t!==void 0?t:""}
        rows="10"
        cols="50"
        required
    ...
    </div>`}renderStar(e){const t=e===this.currentStars,n=`Rate ${e>1?`${e} stars`:"1 star"}`;return g`<button
      class=${`star star-${e}`}
      title=${t?"Clear rating":`${n}`}
      @click=${i=>this.handleStarClicked(i,e)}
    >
      ${e<=this.currentStars?Ct:xt}
    </button> `}handleStarClicked(e,t){e.preventDefault(),this.setStars(t)}handleClearBtnClicked(e){e.preventDefault(),this.currentStars=0}setStars(e){this.currentStars=e===this.currentStars?0:e}static get styles(){return[jt,_`
        :host {
          font-family: var(
            --ia-font-stack,
            'Helvetica Neue',
